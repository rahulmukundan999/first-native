...
const photos = [
    require('../../../assets/icons/nomorewatchingnew.png'),
    require('../../../assets/icons/payngo.png'),
    require('../../../assets/icons/see_order_intro.png'),

];

export default class Slideshow extends React.Component<any, any> {
                        ...
                        <View style={{ alignItems: 'center' }}>
                            ...
                            >
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity onPress={() => this.props.disableImage()}>
                                        <Text style={{ fontSize: 21, color: 'white', fontWeight: "bold" }}>Login</Text>
                                    </TouchableOpacity>
